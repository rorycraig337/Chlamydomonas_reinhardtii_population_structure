...
#pop_list takes two line file, with comma separated list of isolates in each clade on each line
#usage: perl prefilter_VCF.pl --vcf all_sites.vcf --pop_list clades.txt --minA 10 --minB 4 --out snps.min_isolates.vcf
